    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <section className="flex-1 max-w-7xl mx-auto px-2 sm:px-4 py-10 sm:py-16 flex flex-col items-center justify-center min-h-[80vh] gap-10 sm:gap-16">
        ...
        <div className="w-full flex flex-col items-center text-center mb-4 mt-12 sm:mt-16">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground font-medium max-w-2xl mx-auto mb-4">
            Empowering Innovation. Enabling Accessibility. Inspiring Change.
          </p>
        </div>

        {/* What is SARTHI & Objectives */}
        <div className="w-full flex flex-col lg:flex-row gap-6 sm:gap-10 items-stretch justify-center">
          <div className="flex-1 min-w-[0] rounded-2xl bg-white/80 dark:bg-white/10 shadow-md border border-white/30 p-5 sm:p-7 md:p-10 flex flex-col items-center text-center mb-4 lg:mb-0">
            <h2 className="text-2xl sm:text-3xl font-bold mb-3 text-primary">What is SAARTHI?</h2>
          ...
          <div className="flex-1 min-w-[0] rounded-2xl bg-white/80 dark:bg-white/10 shadow-md border border-white/30 p-5 sm:p-6 flex flex-col items-center text-center justify-center min-h-0">
            <h3 className="text-xl sm:text-2xl font-semibold mb-2 text-primary">Objectives</h3>
            <ul className="flex flex-col justify-center items-center gap-2 sm:gap-3 md:gap-4 text-muted-foreground text-base sm:text-lg md:text-xl w-full max-w-xs mx-auto text-center">
              <li className="flex items-center gap-3"><span className="text-primary font-bold text-xl sm:text-2xl">•</span>Empathy-driven innovation</li>
              <li className="flex items-center gap-3"><span className="text-primary font-bold text-xl sm:text-2xl">•</span>Assistive tech for real challenges</li>
              <li className="flex items-center gap-3"><span className="text-primary font-bold text-xl sm:text-2xl">•</span>Inclusive design awareness</li>
              <li className="flex items-center gap-3"><span className="text-primary font-bold text-xl sm:text-2xl">•</span>Mentorship & collaboration</li>
            </ul>
          </div>
        </div>

        {/* Event Highlights */}
        <div className="w-full rounded-2xl bg-white/70 dark:bg-white/10 shadow-md border border-white/30 p-4 sm:p-8 md:p-16 flex flex-col items-center text-center">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6 text-primary">Event Highlights</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-10 w-full">
            <div className="flex flex-col items-center">
              <span className="text-3xl sm:text-4xl mb-2">⏰</span>
              <h4 className="font-semibold text-base sm:text-lg mb-1">24-Hour Hackathon</h4>
              <p className="text-muted-foreground text-xs sm:text-sm">Non-stop coding, creativity, and collaboration to solve real-world challenges.</p>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-3xl sm:text-4xl mb-2">🤝</span>
              <h4 className="font-semibold text-base sm:text-lg mb-1">Mentorship & Networking</h4>
              <p className="text-muted-foreground text-xs sm:text-sm">Guidance from industry experts and opportunities to connect with like-minded peers.</p>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-3xl sm:text-4xl mb-2">💡</span>
              <h4 className="font-semibold text-base sm:text-lg mb-1">Inclusive Innovation</h4>
              <p className="text-muted-foreground text-xs sm:text-sm">Focus on accessibility and impact for Persons with Disabilities (PwDs).</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10">
          <div className="rounded-2xl bg-white/80 dark:bg-white/10 shadow-md border border-white/30 p-6 sm:p-10 flex flex-col items-center text-center min-h-[220px] sm:min-h-[320px]">
            <span className="text-2xl sm:text-3xl mb-2">🌍</span>
            <h2 className="text-xl sm:text-2xl font-semibold mb-2 text-primary">Our Vision</h2>
          ...
          <div className="rounded-2xl bg-white/80 dark:bg-white/10 shadow-md border border-white/30 p-6 sm:p-10 flex flex-col items-center text-center min-h-[220px] sm:min-h-[320px]">
            <span className="text-2xl sm:text-3xl mb-2">🧭</span>
            <h2 className="text-xl sm:text-2xl font-semibold mb-2 text-primary">Why SAARTHI?</h2>
            <p className="text-muted-foreground text-sm sm:text-base">
        ...
        <motion.div className="text-center mb-4" {...fadeInUp}>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6">Prizes & Recognition</h2>
          <p className="text-base sm:text-lg text-muted-foreground">Celebrating innovation and impact</p>
        </motion.div>
        <motion.div className="flex justify-center" {...fadeInUp}>
          <Card className="text-center relative overflow-hidden max-w-xs sm:max-w-xl w-full">
            <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-yellow-400 to-yellow-600"></div>
            <CardHeader className="pt-8 sm:pt-12 pb-6 sm:pb-8">
              <Trophy className="w-14 h-14 sm:w-20 sm:h-20 text-yellow-500 mx-auto mb-4 sm:mb-6" />
              <CardTitle className="text-3xl sm:text-4xl font-extrabold text-primary">₹1,00,000+</CardTitle>
              <CardDescription className="text-xl sm:text-2xl font-semibold text-muted-foreground mt-2">Prize Pool</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-base sm:text-lg text-muted-foreground">Exciting cash prizes, trophies, certificates, and special awards for top teams!</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        <div className="w-full flex flex-col items-center text-center mt-6 sm:mt-8">
          ...
          <a href="https://unstop.com/hackathons/saarthi-2025-graphic-era-hill-university-gehu-dehradun-campus-1564475" className="inline-block px-6 sm:px-8 py-2 sm:py-3 rounded-full bg-primary text-white font-semibold shadow-lg hover:bg-primary/90 transition">Register for SAARTHI'25</a>
        </div>
        ...
        <div className="w-full flex flex-col items-center">
          <div className="w-full max-w-5xl bg-white/90 dark:bg-white/10 rounded-3xl shadow-2xl border border-white/30 overflow-hidden flex flex-col items-center">
            {/* Tabs */}
            <div className="w-full flex flex-wrap justify-center gap-2 md:gap-6 bg-gradient-to-r from-blue-50 via-white to-pink-50 py-4">
              <button
            ...
            {/* Image at the top */}
            <div className="w-full flex justify-center items-center min-h-[180px] sm:min-h-[300px] bg-gradient-to-br from-blue-100 via-white to-pink-100">
              {aboutSection === "gehu" && (
                <img
                  src="/gehu_campus.png"
            ...
            {/* Content below image */}
            <div className="w-full flex flex-col justify-center gap-4 p-4 sm:p-8 md:p-12 items-center text-center">
              {aboutSection === "gehu" && (
                <>
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-primary mb-2">About Graphic Era Hill University</h2>
                  ...
                  <div className="bg-white/95 dark:bg-white/10 rounded-xl shadow p-4 mt-2 w-full max-w-xl mx-auto">
                    <h3 className="text-lg sm:text-xl font-semibold text-primary mb-2">Why GEHU?</h3>
              ...
              {aboutSection === "cse" && (
                <>
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-primary mb-2">About CSE & SOC Department</h2>
                  <p className="text-base sm:text-lg text-muted-foreground">
                  ...
                  <div className="bg-white/95 dark:bg-white/10 rounded-xl shadow p-4 mt-2 w-full max-w-xl mx-auto">
                    <h3 className="text-lg sm:text-xl font-semibold text-primary mb-2">Key Highlights</h3>
                    <ul className="space-y-2 text-sm sm:text-base md:text-lg text-gray-700 dark:text-gray-200 text-left">
